...
export function Account() {
  ...
  const menuItems = [
    { icon: <CreditCard size={20} />, label: 'Payment Methods', badge: '2 Cards' },
    { icon: <History size={20} />, label: 'Purchase History', badge: '24 Items' },
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        >
          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl p-6 text-white">
            ...
            <div className="text-2xl md:text-3xl font-bold mb-4">250,000 MMK</div>
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className={`p-2 rounded-lg ${
                      ...
                      transaction.type === 'win' ? 'bg-yellow-100' : 'bg-red-100'
                    }`}>
                      {transaction.type === 'deposit' ? <ArrowDownRight className="text-green-600" /> :
                       transaction.type === 'win' ? <Gift className="text-yellow-600" /> :
